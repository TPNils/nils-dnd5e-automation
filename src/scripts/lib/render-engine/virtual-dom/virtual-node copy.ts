...
// //#region attribute
// class DefaultVirtualAttributeNode implements VirtualAttributeNode {
...
//     return this._attributes.get(qualifiedName?.toLowerCase());
//   }
...
//     }
//     this._attributes.set(qualifiedName?.toLowerCase(), value == null ? '' : value);
//   }

//   public removeAttribute(qualifiedName: string): void {
//     this._attributes.delete(qualifiedName?.toLowerCase());
//   }
...
//       this._attributes.set(attrName, original.getAttribute(attrName));
//     }
//   }
...
// class DefaultVirtualChildNode implements VirtualChildNode {
//   private _parentNode: VirtualParentNode;
...
// }
// class DefaultVirtualEventNode implements VirtualEventNode {
//   private _callbackMap = new Map<number, StoredEventCallback>();

//   public getEventListerners(): Iterable<StoredEventCallback> {
//     return this._callbackMap.values();
//   }
...
//     }
//     this._callbackMap.set(callback[eventCallbackId], {type: type, callback: callback, options: options, guid: callback[eventCallbackId]});
//   }
...
//     this._callbackMap.delete(callback[eventCallbackId]);
//   }
...
//       this._callbackMap.set(listener.callback[eventCallbackId], listener);
//     }
//   }
// }
...
// class DefaultVirtualParentNode implements VirtualParentNode {
//   private _childNodes: Array<VirtualChildNode & VirtualNode> = [];
...
//     this.insertIndex('appendChild', this._childNodes.length, nodes);
//   }
...
//     this._childNodes.splice(index, 0, ...nodes);
//     for (const node of nodes) {
...
//     return this._childNodes.splice(index, 1, ...nodes)[0] as any;
//   }
...
//   parent?: boolean;
// }
// export function VNode(params: {attribute: true}): Constructor<DefaultVirtualAttributeNode>
// export function VNode(params: {child: true}): Constructor<DefaultVirtualChildNode>
// export function VNode(params: {event: true}): Constructor<DefaultVirtualEventNode>
// export function VNode(params: {parent: true}): Constructor<DefaultVirtualParentNode>
// export function VNode(params: {attribute: true, child: true}): Constructor<DefaultVirtualAttributeNode & DefaultVirtualChildNode>
// export function VNode(params: {attribute: true, event: true}): Constructor<DefaultVirtualAttributeNode & DefaultVirtualEventNode>
// export function VNode(params: {attribute: true, parent: true}): Constructor<DefaultVirtualAttributeNode & DefaultVirtualParentNode>
// export function VNode(params: {child: true, event: true}): Constructor<DefaultVirtualChildNode & DefaultVirtualEventNode>
// export function VNode(params: {child: true, parent: true}): Constructor<DefaultVirtualChildNode & DefaultVirtualParentNode>
// export function VNode(params: {event: true, parent: true}): Constructor<DefaultVirtualEventNode & DefaultVirtualParentNode>
// export function VNode(params: {child: true, event: true, parent: true}): Constructor<DefaultVirtualChildNode & DefaultVirtualEventNode & DefaultVirtualParentNode>
// export function VNode(params: {attribute: true, event: true, parent: true}): Constructor<DefaultVirtualAttributeNode & DefaultVirtualChildNode & DefaultVirtualParentNode>
// export function VNode(params: {attribute: true, child: true, parent: true}): Constructor<DefaultVirtualAttributeNode & DefaultVirtualChildNode & DefaultVirtualParentNode>
// export function VNode(params: {attribute: true, child: true, event: true}): Constructor<DefaultVirtualAttributeNode & DefaultVirtualChildNode & DefaultVirtualEventNode>
// export function VNode(params: {attribute: true, child: true, event: true, parent: true}): Constructor<DefaultVirtualAttributeNode & DefaultVirtualChildNode & DefaultVirtualEventNode & DefaultVirtualParentNode>
// export function VNode(params?: NodeParams): Constructor
// export function VNode(params: NodeParams = {}): Constructor {
//   const builderClass = class {
//   }
//   const mixinClasses: any[] = [];
//   if (params.attribute) {
//     mixinClasses.push(DefaultVirtualAttributeNode);
//   }
//   if (params.child) {
//     mixinClasses.push(DefaultVirtualChildNode);
//   }
//   if (params.event) {
//     mixinClasses.push(DefaultVirtualEventNode);
//   }
//   if (params.parent) {
//     mixinClasses.push(DefaultVirtualParentNode);
//   }
  
//   // const basePrototype: any = builderClass.prototype;
//   // for (const mixinClass of mixinClasses) {
//   //   const descriptors = Object.getOwnPropertyDescriptors(mixinClass.prototype);
//   //   delete descriptors.constructor; // Don't copy constructor
//   //   UtilsLog.debug(mixinClass.name, descriptors);
//   //   for (const field of Object.keys(descriptors)) {
//   //     Object.defineProperty(basePrototype, field, descriptors[field]);
//   //   }
//   // }
//   for (const mixinClass of mixinClasses) {
//     builderClass = class
